...
return(
  ...
  <div className="scroll-Compromisos rounded mb-4">
    ...
    <ol className="mt-2" align="left">
    <li className="text-white h5"><span className="colorTurquesa" >Congreso de Medicos</span> <span className="text-white h4">-</span> <span className="colorSalmon">3:00 Pm</span> </li>
    <li className="text-white  h5"><span className="colorTurquesa">Reunion Sobre Operacion De Clavicula</span> <span className="text-white h4">-</span> <span className="colorSalmon">5:00 Pm</span></li>
    <li className="text-white  h5"><span className="colorTurquesa">Operacion De Torax</span><span className="text-white h4"> -</span> <span className="colorSalmon">7:00 Pm</span></li>
    <li className="text-white  h5"><span className="colorTurquesa">Clase De Anatomia</span><span className="text-white h4"> -</span>  <span className="colorSalmon">8:00 Pm</span></li>
    <li className="text-white  h5"><span className="colorTurquesa">Fiesta Del Hospital</span><span className="text-white h4"> -</span><span className="colorSalmon"> 10:00 Pm</span></li>
    <li className="text-white  h5"><span className="colorTurquesa">Hora de Lectura</span><span className="text-white h4"> -</span> <span className="colorSalmon">11:30 Pm</span></li>
